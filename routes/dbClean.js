...
function cleanCoLive (){ // 최근 2분치만 저정하도록 구현
    var d = new Date();
    var now = moment(d).add("-2","minute").format(fmt1);
...
function cleanH2hoLive (){ // 최근 2분치만 저정하도록 구현
    var d = new Date();
    var now = moment(d).add("-2","minute").format(fmt1);
...
function cleanRadonLive (){ // 최근 2분치만 저정하도록 구현
    var d = new Date();
    var now = moment(d).add("-2","minute").format(fmt1);
...
module.exports = {
    ...
    ,cleanVocLive, cleanCoLive, cleanH2hoLive, cleanRadonLive
}